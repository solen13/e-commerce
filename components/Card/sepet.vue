<template>
  <div class="card" >
    <v-card  class="cardList "  max-height="350">
      <v-card v-for="(item,index) in $store.state.shoppingCart" :key="index" class="blue-grey lighten-5 d-flex justify-lg-space-around align-center mt-1" width="300"  >
    ...
    <v-card class="total d-flex align-center justify-lg-space-around">
